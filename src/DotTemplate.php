...
use DotKernel\DotTemplate\Exception\HaltException;
...
class DotTemplate
{
	 ...
	 * @param array $setVars   Variables to be set initially
	 * @return void
	 */
	public function __construct($root = '.', $unknowns = 'remove', $fallback='', $setVars=array())
	{
		$this->setRoot($root);
		$this->setUnknowns($unknowns);
		if (is_array($fallback))
		{
			$this->_fileFallbacks = $fallback;
		}
		if(is_array($setVars))
		{
